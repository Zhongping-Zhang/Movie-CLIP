...
from models.movieclip import trailer_audio
from train import str2bool, sigmoid

def train(epoch):
    model.train()
    for batch_idx, sample in enumerate(train_loader):
        movie_id, label, audio_feature = sample['movie_id'],sample['label_onehot'],sample['audio_feature']
        audio_feature = audio_feature.to(device).type(FloatTensor)
...
def main(args):
    ...
    model = trailer_audio(audio_feature_dim=audio_feature_dim,
...
if __name__=="__main__":
    ...
    parser.add_argument('--model_name', type=str, default='trailer_audio', help='model name')
