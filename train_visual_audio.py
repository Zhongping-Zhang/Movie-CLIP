...
from models.movieclip import trailer_visual_audio
...
def train(epoch):
    ...
    for batch_idx, sample in enumerate(train_loader):
        ...
        optimizer.zero_grad()
        output_dict = model(visual_feature, audio_feature)
        visual_output, audio_output, output = output_dict["visual_output"],output_dict["audio_output"],output_dict["multimodal_output"]
...
def main(args):
    ...
    model = trailer_visual_audio(visual_feature_dim=visual_feature_dim,
